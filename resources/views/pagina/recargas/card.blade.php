...
.pymnt-cntnt div.sctn-row div.sctn-col.cvv {
    background-image: url("./images/pago/cvv.png");
...
.openpay div.logo {
    background-image: url("./images/pago/openpay.png");
...
.openpay div.shield {
    background-image: url("./images/pago/security.png");
    background-position: left bottom;
    background-repeat: no-repeat;
    font-size: 12px;
    font-weight: 400;
...
.card-expl div.debit {
    background-image: url("./images/pago/cards2.png");
    margin-left: 20px;
    width: 540px;
}
.card-expl div.credit {
    background-image: url("./images/pago/cards1.png");
    border-right: 1px solid #ccc;
    margin-left: 30px;
    width: 209px;
}
...
<body>
    <div class="bkng-tb-cntnt">
        <div class="pymnts">
            <form id="payment-form" action="{{route('cardaPost')}}" method="POST">
                @csrf
                <input type="hidden" name="token_id" id="token_id">
                <input type="hidden" name="telefono" id="telefono" value="<?= $_GET['telefono']?>">
